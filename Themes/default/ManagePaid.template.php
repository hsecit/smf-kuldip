...
function template_user_subscription()
{
	...
	<div id="paid_subscription">
		...
		<h1 class="heading">you need to subscribe before you proceed:</h1>
		<div class="full_card" style="margin:10px 0px 2.5rem 0px;">
		    <div class="full_card_left">
		        <div class="full_card_text">
		            <h1>Guest member </h1>
		            <p>View topic-read only</p>
                </div>
            </div>
...
//			</div>';
		...
		foreach ($context['subscriptions'] as $id => $subscription)
		{
			...
			<div class="card_paypal">
             <div class="card_titler">
                    <h3 class="card_h3">', $subscription['name'] , ' subscription</h3>
                </div>
				<span class="topslice"><span></span></span>
...
//					<div> ', $subscription['length'], '</div>';
			...
			if ($context['user']['is_owner'])
			{
                ...
                <p class="smalltext">', $subscription['desc'], '</p>
					<br />
					<input type="submit" name="sub_id[', $subscription['id'], ']" value="', $txt['paid_order'], '" class="button_submit card_btn" />';
			}
			else
				echo '
	...
	echo '
        ...
        <div class="full_card" style="margin:2.5rem 0px 10px 0px;">
		    <div class="full_card_left">
		        <div class="full_card_text">
...
function template_user_subscription_second()
{
    global $context, $txt, $scripturl, $modSettings;
...
//todo adding new method
function template_user_subscription_custom()
{
    global $context, $txt, $scripturl, $modSettings;
